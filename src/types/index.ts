...
export interface Agent {
  ...
  corpulence: string;
  allergy_animals: boolean;
  shoe_size: string;
  is_smoking: boolean;
  availability_calendar?: Record<string, { active: boolean; start: string; end: string }>;
  ...
  neighborhood: string;
  statut: string;
  disponibilite_intervention: string;
  standby_days?: number;
