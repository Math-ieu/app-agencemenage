...
export default function Dashboard() {
  ...
  const openDetail = (d: Demande, autoExpand: boolean = false) => {
    ...
    setEditFormData({
      ...
      client_name: d.client_name || d.client_name_display || d.client_detail?.display_name || formData.nom || formData.fullName || '',
      client_phone: d.client_phone || d.client_phone_display || d.client_detail?.phone || formData.phone || formData.whatsapp_phone || '',
      client_whatsapp: d.client_whatsapp || d.client_whatsapp_display || d.client_detail?.whatsapp || formData.whatsapp_phone || formData.whatsapp || '',
      client_email: d.client_email || d.client_detail?.email || formData.email || '',
      ...
      ville: formData.ville || d.client_city || d.client_detail?.city || 'Casablanca',
      quartier: normalizeQuartier(formData.quartier || d.client_neighborhood || d.client_detail?.neighborhood || ''),
      adresse: formData.adresse || d.client_address || d.client_detail?.address || '',
