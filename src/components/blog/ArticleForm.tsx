    ...
    <div className="min-h-screen bg-background blog-literal flex items-center justify-center p-8">
      <div className="max-w-md w-full premium-card p-12 text-center space-y-6">
        <div className="h-20 w-20 rounded-3xl bg-accent/10 text-accent flex items-center justify-center mx-auto shadow-lg shadow-accent/5">
          <Edit className="h-10 w-10 animate-pulse" />
        </div>
        <div className="space-y-2">
          <h1 className="text-2xl font-bold text-foreground tracking-tight">Espace Rédaction</h1>
          <p className="text-muted-foreground font-medium leading-relaxed">
            L'outil d'édition d'article est <span className="text-accent font-semibold">en cours de développement</span>.
          </p>
        </div>
        <div className="pt-4">
          <div className="h-1.5 w-full bg-muted rounded-full overflow-hidden">
            <div className="h-full bg-accent animate-progress-buffer w-1/4 rounded-full" />
          </div>
